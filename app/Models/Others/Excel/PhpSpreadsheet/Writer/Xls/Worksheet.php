...
namespace App\Models\Others\Excel\PhpSpreadsheet\Writer\Xls;

use GdImage;
use App\Models\Others\Excel\PhpSpreadsheet\Cell\Coordinate;
use App\Models\Others\Excel\PhpSpreadsheet\Cell\DataType;
use App\Models\Others\Excel\PhpSpreadsheet\Exception as PhpSpreadsheetException;
use App\Models\Others\Excel\PhpSpreadsheet\RichText\RichText;
use App\Models\Others\Excel\PhpSpreadsheet\RichText\Run;
use App\Models\Others\Excel\PhpSpreadsheet\Shared\StringHelper;
use App\Models\Others\Excel\PhpSpreadsheet\Shared\Xls;
use App\Models\Others\Excel\PhpSpreadsheet\Style\Border;
use App\Models\Others\Excel\PhpSpreadsheet\Style\Color;
use App\Models\Others\Excel\PhpSpreadsheet\Style\Conditional;
use App\Models\Others\Excel\PhpSpreadsheet\Style\Protection;
use App\Models\Others\Excel\PhpSpreadsheet\Worksheet\PageSetup;
use App\Models\Others\Excel\PhpSpreadsheet\Worksheet\SheetView;
use App\Models\Others\Excel\PhpSpreadsheet\Writer\Exception as WriterException;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \App\Models\Others\Excel\PhpSpreadsheet\Writer\Xls\Parser
     */
    private $parser;
     ...
     * Sheet object.
     *
     * @var \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet
     */
    public $phpSheet;
     ...
     *
     * @var null|\App\Models\Others\Excel\PhpSpreadsheet\Shared\Escher
     */
    private $escher;
     ...
     * @param \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet $phpSheet)
    {
     ...
     *
     * @see \App\Models\Others\Excel\PhpSpreadsheet\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close(): void
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \App\Models\Others\Excel\PhpSpreadsheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParent()->getDefaultStyle()->getFont());
        }
    ...
    private function writeBreaks(): void
    {
        ...
        foreach ($this->phpSheet->getBreaks() as $cell => $breakType) {
            ...
            switch ($breakType) {
                case \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet::BREAK_COLUMN:
                    // Add to list of vertical breaks
                    $vbreaks[] = Coordinate::columnIndexFromString($coordinates[0]) - 1;

                    break;
                case \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet::BREAK_ROW:
                    // Add to list of horizontal breaks
                    $hbreaks[] = $coordinates[1];

                    break;
                case \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet::BREAK_NONE:
                default:
                    // Nothing to do
                    break;
            }
     ...
     * Get Escher object.
     */
    public function getEscher(): ?\App\Models\Others\Excel\PhpSpreadsheet\Shared\Escher
    {
        return $this->escher;
    }
     ...
     * Set Escher object.
     */
    public function setEscher(?\App\Models\Others\Excel\PhpSpreadsheet\Shared\Escher $escher): void
    {
        $this->escher = $escher;
    }
    ...
    private function writeCFRule(Conditional $conditional): void
    {
        ...
        if ($bFormatFont == 1) {
            ...
            switch ($conditional->getStyle()->getFont()->getUnderline()) {
                case \App\Models\Others\Excel\PhpSpreadsheet\Style\Font::UNDERLINE_NONE:
                    $dataBlockFont .= pack('C', 0x00);
                    $fontUnderline = 0;

                    break;
                case \App\Models\Others\Excel\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLE:
                    $dataBlockFont .= pack('C', 0x02);
                    $fontUnderline = 0;

                    break;
                case \App\Models\Others\Excel\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLEACCOUNTING:
                    $dataBlockFont .= pack('C', 0x22);
                    $fontUnderline = 0;

                    break;
                case \App\Models\Others\Excel\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE:
                    $dataBlockFont .= pack('C', 0x01);
                    $fontUnderline = 0;

                    break;
                case \App\Models\Others\Excel\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLEACCOUNTING:
