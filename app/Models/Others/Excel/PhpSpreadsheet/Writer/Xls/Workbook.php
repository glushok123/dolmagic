...
class Workbook extends BIFFwriter
{
     ...
     * XF Writers.
     *
     * @var \App\Models\Others\Excel\PhpSpreadsheet\Writer\Xls\Xf[]
     */
    private $xfWriters = [];
     ...
     */
    public function addFont(\App\Models\Others\Excel\PhpSpreadsheet\Style\Font $font)
    {
     ...
     */
    private function writeBoundSheet(\App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet $sheet, $offset): void
    {
        ...
        switch ($sheet->getSheetState()) {
            case \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE:
                $ss = 0x00;

                break;
            case \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_HIDDEN:
                $ss = 0x01;

                break;
            case \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN:
                $ss = 0x02;
