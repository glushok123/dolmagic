...
use App\Models\Others\Excel\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalDataBar;
use App\Models\Others\Excel\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalFormattingRuleExtension;
use App\Models\Others\Excel\PhpSpreadsheet\Worksheet\AutoFilter\Column;
use App\Models\Others\Excel\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule;
use App\Models\Others\Excel\PhpSpreadsheet\Worksheet\SheetView;
use App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet as PhpspreadsheetWorksheet;
...
class Worksheet extends WriterPart
{
    ...
    private function writeCellFormula(XMLWriter $objWriter, string $cellValue, Cell $cell): void
    {
        ...
        if (is_string($calculatedValue)) {
            if (\App\Models\Others\Excel\PhpSpreadsheet\Calculation\Functions::isError($calculatedValue)) {
    ...
    private function writeDrawings(XMLWriter $objWriter, PhpspreadsheetWorksheet $worksheet, $includeCharts = false): void
    {
        ...
        if (isset($unparsedLoadedData['sheets'][$worksheet->getCodeName()]['drawingOriginalIds'])) {
            ...
            // (! synchronize with \App\Models\Others\Excel\PhpSpreadsheet\Writer\Xlsx\Rels::writeWorksheetRelationships)
