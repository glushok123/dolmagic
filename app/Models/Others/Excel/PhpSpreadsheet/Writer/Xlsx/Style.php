...
class Style extends WriterPart
{
     ...
     * Write Cell Style Xf.
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \App\Models\Others\Excel\PhpSpreadsheet\Style\Style $style, Spreadsheet $spreadsheet): void
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \App\Models\Others\Excel\PhpSpreadsheet\Style\Style $style): void
    {
        // dxf
     ...
     *
     * @return \App\Models\Others\Excel\PhpSpreadsheet\Style\Style[] All styles in PhpSpreadsheet
     */
    ...
    public function allFills(Spreadsheet $spreadsheet)
    {
        ...
        /** @var \App\Models\Others\Excel\PhpSpreadsheet\Style\Style $style */
