...
namespace App\Models\Others\Excel\PhpSpreadsheet\Writer\Xlsx;

use App\Models\Others\Excel\PhpSpreadsheet\Cell\Coordinate;
use App\Models\Others\Excel\PhpSpreadsheet\Shared\XMLWriter;
use App\Models\Others\Excel\PhpSpreadsheet\Spreadsheet;
use App\Models\Others\Excel\PhpSpreadsheet\Worksheet\BaseDrawing;
use App\Models\Others\Excel\PhpSpreadsheet\Worksheet\HeaderFooterDrawing;
...
class Drawing extends WriterPart
{
     ...
     */
    public function writeDrawings(\App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet $worksheet, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     */
    public function writeChart(XMLWriter $objWriter, \App\Models\Others\Excel\PhpSpreadsheet\Chart\Chart $chart, $relationId = -1): void
    {
        ...
        $objWriter->writeElement('xdr:colOff', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($tl['xOffset']));
        $objWriter->writeElement('xdr:row', $tlColRow[1] - 1);
        $objWriter->writeElement('xdr:rowOff', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($tl['yOffset']));
        $objWriter->endElement();
        $objWriter->startElement('xdr:to');
        $objWriter->writeElement('xdr:col', $brColRow[0] - 1);
        $objWriter->writeElement('xdr:colOff', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($br['xOffset']));
        $objWriter->writeElement('xdr:row', $brColRow[1] - 1);
        $objWriter->writeElement('xdr:rowOff', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($br['yOffset']));
        $objWriter->endElement();
    ...
    public function writeDrawing(XMLWriter $objWriter, BaseDrawing $drawing, $relationId = -1, $hlinkClickId = null): void
    {
        if ($relationId >= 0) {
            ...
            $objWriter->writeElement('xdr:colOff', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($drawing->getOffsetX()));
            $objWriter->writeElement('xdr:row', $aCoordinates[1] - 1);
            $objWriter->writeElement('xdr:rowOff', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($drawing->getOffsetY()));
            $objWriter->endElement();

            // xdr:ext
            $objWriter->startElement('xdr:ext');
            $objWriter->writeAttribute('cx', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($drawing->getWidth()));
            $objWriter->writeAttribute('cy', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($drawing->getHeight()));
            $objWriter->endElement();
            ...
            $objWriter->writeAttribute('rot', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::degreesToAngle($drawing->getRotation()));
            $objWriter->endElement();
            ...
            if ($drawing->getShadow()->getVisible()) {
                ...
                $objWriter->writeAttribute('blurRad', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($drawing->getShadow()->getBlurRadius()));
                $objWriter->writeAttribute('dist', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($drawing->getShadow()->getDistance()));
                $objWriter->writeAttribute('dir', \App\Models\Others\Excel\PhpSpreadsheet\Shared\Drawing::degreesToAngle($drawing->getShadow()->getDirection()));
     ...
     * @return string XML Output
     */
    public function writeVMLHeaderFooterImages(\App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet $worksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
