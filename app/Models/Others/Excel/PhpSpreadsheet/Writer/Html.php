...
use App\Models\Others\Excel\PhpSpreadsheet\Chart\Chart;
...
use App\Models\Others\Excel\PhpSpreadsheet\Shared\Font as SharedFont;
...
class Html extends BaseWriter
{
     ...
     *
     * @param Worksheet $worksheet \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet
    ...
    private function generateRowWriteCell(&$html, Worksheet $worksheet, $coordinate, $cellType, $cellData, $colSpan, $rowSpan, $cssClass, $colNum, $sheetIndex, $row): void
    {
        ...
        if (!$this->useInlineCss && !$this->isPdf) {
            ...
            //** Necessary redundant code for the sake of \App\Models\Others\Excel\PhpSpreadsheet\Writer\Pdf **
    ...
    private function generatePageDeclarations($generateSurroundingHTML)
    {
        ...
        foreach ($sheets as $worksheet) {
            ...
            if ($orientation === \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_LANDSCAPE) {
                $htmlPage .= 'size: landscape; ';
            } elseif ($orientation === \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_PORTRAIT) {
