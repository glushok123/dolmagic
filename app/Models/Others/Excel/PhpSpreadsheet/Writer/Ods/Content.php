...
namespace App\Models\Others\Excel\PhpSpreadsheet\Writer\Ods;
...
use App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Row;
use App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet;
use App\Models\Others\Excel\PhpSpreadsheet\Writer\Exception;
use App\Models\Others\Excel\PhpSpreadsheet\Writer\Ods;
use App\Models\Others\Excel\PhpSpreadsheet\Writer\Ods\Cell\Comment;
use App\Models\Others\Excel\PhpSpreadsheet\Writer\Ods\Cell\Style;
...
class Content extends WriterPart
{
    ...
    private function writeCells(XMLWriter $objWriter, Row $row): void
    {
        ...
        while ($cells->valid()) {
            /** @var \App\Models\Others\Excel\PhpSpreadsheet\Cell\Cell $cell */
            $cell = $cells->current();
