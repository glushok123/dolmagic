...
namespace App\Models\Others\Excel\PhpSpreadsheet\Cell;
...
use App\Models\Others\Excel\PhpSpreadsheet\Shared\Date as SharedDate;
use App\Models\Others\Excel\PhpSpreadsheet\Style\ConditionalFormatting\CellStyleAssessor;
        ...
        if ($this->dataType == DataType::TYPE_FORMULA) {
            try {
                ...
                if (($ex->getMessage() === 'Unable to access External Workbook') && ($this->calculatedValue !== null)) {
                    ...
                    return \App\Models\Others\Excel\PhpSpreadsheet\Calculation\Functions::NAME();
                }

                throw new \App\Models\Others\Excel\PhpSpreadsheet\Calculation\Exception(
