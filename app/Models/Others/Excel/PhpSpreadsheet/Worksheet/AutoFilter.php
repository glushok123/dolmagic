...
use App\Models\Others\Excel\PhpSpreadsheet\Calculation\Internal\WildcardMatch;
    ...
    public function __clone()
    {
        ...
        foreach ($vars as $key => $value) {
            if (is_object($value)) {
                ...
                //    The columns array of \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet\AutoFilter objects
                $this->{$key} = [];
