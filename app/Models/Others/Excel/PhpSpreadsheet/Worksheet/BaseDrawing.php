...
class BaseDrawing implements IComparable
{
    ...
    public function setWorksheet(?Worksheet $worksheet = null, $overrideOld = false)
    {
        if ($this->worksheet === null) {
            // Add drawing to \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet
            $this->worksheet = $worksheet;
            $this->worksheet->getCell($this->coordinates);
            $this->worksheet->getDrawingCollection()->append($this);
        } else {
            if ($overrideOld) {
                // Remove drawing from old \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet
                ...
                // Set new \App\Models\Others\Excel\PhpSpreadsheet\Worksheet\Worksheet
