...
namespace App\Models\Others\Excel\PhpSpreadsheet\Reader\Xlsx;
...
class Chart
{
     ...
     *
     * @return \App\Models\Others\Excel\PhpSpreadsheet\Chart\Chart
     */
    public static function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \App\Models\Others\Excel\PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, $dispBlanksAs, $XaxisLabel, $YaxisLabel);
