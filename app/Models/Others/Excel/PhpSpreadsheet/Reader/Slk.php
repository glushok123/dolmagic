...
use App\Models\Others\Excel\PhpSpreadsheet\Reader\Exception as ReaderException;
    ...
    private function styleSettings(string $rowDatum, array &$styleData, string &$fontStyle): void
    {
        ...
        for ($i = 0; $i < $iMax; ++$i) {
            ...
            if (array_key_exists($char, self::STYLE_SETTINGS_FONT)) {
                ...
                $styleData['fill']['fillType'] = \App\Models\Others\Excel\PhpSpreadsheet\Style\Fill::FILL_PATTERN_GRAY125;
            } elseif ($char == 'M') {
