...
class Drawing
{
     ...
     */
    public static function pixelsToCellDimension($pixelValue, \App\Models\Others\Excel\PhpSpreadsheet\Style\Font $defaultFont)
    {
        // Font name and size
     ...
     * @param \App\Models\Others\Excel\PhpSpreadsheet\Style\Font $defaultFont Default font of the workbook
     *
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($cellWidth, \App\Models\Others\Excel\PhpSpreadsheet\Style\Font $defaultFont)
    {
        // Font name and size
        $name = $defaultFont->getName();
        $size = $defaultFont->getSize();
